        ...
        <div class="card-body">
            <form method="GET" action="{{ route('pelanggan.games.list') }}" class="row g-3">
                <div class="col-md-3">
                    ...
                    <select name="platform" class="form-select" style="background-color: #FFFFFF; border-color: #A3A3A3; color: #222222;">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="genre" value="{{ request('genre') }}" class="form-control" style="background-color: #FFFFFF; border-color: #A3A3A3; color: #222222;" placeholder="Contoh: Action, RPG">
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="q" value="{{ request('q') }}" class="form-control" style="background-color: #FFFFFF; border-color: #A3A3A3; color: #222222;" placeholder="Nama game...">
                    </div>
                </div>
